...
//
//    @Autowired
//    private DelegateUserCreaterService aUserCreateService;
//
//    @ApiOperation("代理商和商户注册")
//    @RequestMapping(value = "/createuser", method = RequestMethod.POST)
//    @ResponseBody
//    public CommonResult creatuser(@RequestBody HFUserParam hfUserParam) throws Exception {
//        System.out.println("接口传入的数据:" + hfUserParam.getUsername() + hfUserParam.getPassword() + hfUserParam.getMobileno());
//        aUserCreateService.createDelegate(hfUserParam);
//        return CommonResult.success(1);
//    }
//
//
////    @ApiOperation("个人商户注册  --  接口调试用")
